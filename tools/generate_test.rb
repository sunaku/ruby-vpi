...
def generateVerilogBench aModuleInfo, aOutputInfo
	...
	%{
		module #{aOutputInfo.verilogBenchName};
			...
			initial begin
				#{clockSignal} = 0;
				$ruby_init("-w", "#{aOutputInfo.rubyBenchPath}"#{', "-f", "s"' if aOutputInfo.specFormat == :RSpec});
			end
...
class OutputInfo
	...
	attr_reader :verilogBenchName, :verilogBenchPath, :rubyBenchName, :rubyBenchPath, :designName, :designClassName, :designPath, :specName, :specClassName, :specFormat, :specPath, :rubyVpiPath, :runnerName, :runnerPath
