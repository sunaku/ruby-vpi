...
#
# For example, when the interface of a Verilog module changes, you would simply re-run this tool (with the help of a smart merging tool, such as kdiff3) to incorporate those changes into the test without diverting your focus from the specification.
#
# == Notes
